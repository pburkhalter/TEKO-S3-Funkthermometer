 ...
 */
    ...
    class qs extends Bs {
        ...
        _computeLabelSizes(t, e) {
            ...
            for (l = 0; l < e; ++l) {
                if (d = t[l].label, f = this._resolveTickFontOptions(l), i.font = g = f.string, p = o[g] = o[g] || {
                    ...
                    if (n(d)) for (h = 0, c = d.length; h < c; ++h) _ = d[h], s(_) || n(_) || (b = De(i, p.data, p.gc, b, _), x += m)
            ...
            const M = a.indexOf(y), w = r.indexOf(v), k = t => ({width: a[t] || 0, height: r[t] || 0});
        ...
        _computeGridLineItems(t) {
            const e = this.axis, i = this.chart, s = this.options, {grid: n, position: a, border: r} = s, h = n.offset,
                c = this.isHorizontal(), d = this.ticks.length + (h ? 1 : 0), u = Ys(n), f = [],
        ...
        _computeLabelItems(t) {
            const e = this.axis, i = this.options, {position: s, ticks: a} = i, r = this.isHorizontal(),
                l = this.ticks, {align: h, crossAlign: c, padding: d, mirror: u} = a, f = Ys(i.grid), g = f + d,
    ...
    class Js {
        ...
        _createDescriptors(t, e) {
            const i = t && t.config, s = l(i.options && i.options.plugins, {}), n = function (t) {
                const e = {}, i = [], s = Object.keys(Zs.plugins.items);
            ...
            return !1 !== s || e ? function (t, {plugins: e, localIds: i}, s, n) {
                ...
                for (const r of e) {
                    ...
                    null !== l && o.push({plugin: r, options: tn(t.config, {plugin: r, local: i[e]}, l, a)})
                }
                return o
            }(t, n, s, e) : []
        }
    ...
    function nn(t) {
        ...
        e.plugins = l(e.plugins, {}), e.scales = function (t, e) {
            const i = re[t.type] || {scales: {}}, s = e.scales || {}, n = en(t.type, e), a = Object.create(null);
            return Object.keys(s).forEach((t => {
                ...
                const r = sn(t, e), l = function (t, e) {
                    return t === e ? "_index_" : "_value_"
                }(r, n), h = i.scales || {};
                a[t] = x(Object.create(null), [{axis: r}, e, h[r], h[l]])
            })), t.data.datasets.forEach((i => {
                const n = i.type || t.type, o = i.indexAxis || en(n, e), r = (re[n] || {}).scales || {};
    ...
    class cn {
        ...
        resolveNamedOptions(t, e, i, s = [""]) {
            const o = {$shared: !0}, {resolver: a, subPrefixes: r} = dn(this._resolverCache, t, s);
            let l = a;
            if (function (t, e) {
    ...
    class Mn {
        ...
        constructor(t, e) {
            const s = this.config = new cn(e), n = xn(t), o = yn(n);
        ...
        buildOrUpdateScales() {
            ...
            e && (n = n.concat(Object.keys(e).map((t => {
                const i = e[t], s = sn(t, i), n = "r" === s, o = "x" === s;
                return {
                    options: i,
                ...
                const n = e.options, o = n.id, a = sn(o, n), r = l(n.type, e.dtype);
        ...
        buildOrUpdateControllers() {
            ...
            for (this._removeUnreferencedMetasets(), i = 0, s = e.length; i < s; i++) {
                ...
                if (n.type && n.type !== o && (this._destroyDatasetMeta(i), n = this.getDatasetMeta(i)), n.type = o, n.indexAxis = s.indexAxis || en(o, this.options), n.order = s.order || 0, n.index = i, n.label = "" + s.label, n.visible = this.isDatasetVisible(i), n.controller) n.controller.updateIndex(i), n.controller.linkScales(); else {
                    const e = Zs.getController(o), {datasetElementType: s, dataElementType: a} = ue.datasets[o];
                    Object.assign(e, {
        ...
        update(t) {
            ...
            o = this._minPadding = i.layout.autoPadding ? o : 0, this._updateLayout(o), s || u(n, (t => {
                t.reset()
            })), this._updateDatasets(t), this.notifyPlugins("afterUpdate", {mode: t}), this._layers.sort(pn("z", "_idx"));
        ...
        render() {
            !1 !== this.notifyPlugins("beforeRender", {cancelable: !0}) && (xt.has(this) ? this.attached && !xt.running(this) && xt.start(this) : (this.draw(), mn({chart: this})))
        }
    ...
    var Fn = Object.freeze({
        __proto__: null, BarController: class extends Vs {
            ...
            _calculateBarValuePixels(t) {
                const {_cachedMeta: {vScale: e, _stacked: i, index: n}, options: {base: o, minBarLength: a}} = this,
                    r = o || 0, l = this.getParsed(t), h = l._custom, c = An(h);
        ...
        }, DoughnutController: In, LineController: class extends Vs {
            static id = "line";
        ...
        }, PolarAreaController: zn, PieController: class extends In {
            static id = "pie";
    ...
    function Nn(t, e, i, s, n, o) {
        ...
        const p = (g - Math.max(.001, g * d - i / C) / d) / 2, m = l + p + f, b = n - p - f, {
                ...
                innerStart: y,
                innerEnd: v
            } = Vn(e, u, d, b - m), M = d - x, w = d - _, k = m + x / M, S = b - _ / w, P = u + y, D = u + v, O = m + y / P,
            A = b - v / D;
        if (t.beginPath(), o) {
            const e = (k + S) / 2;
    ...
    var no = Object.freeze({
        ...
        }, LineElement: Gn, PointElement: class extends Bs {
            static id = "point";
            static defaults = {
                borderWidth: 1,
                hitRadius: 1,
    ...
    class lo extends qs {
        ...
        buildTicks() {
            ...
            const n = function (t, e) {
                ...
                let D = 0;
                for (b && (u && M !== a ? (i.push({value: a}), M < a && D++, V(Math.round((M + D * S) * v) / v, a, ro(a, y, t)) && D++) : M < a && D++); D < k; ++D) i.push({value: Math.round((M + D * S) * v) / v});
                return x && u && w !== r ? i.length && V(i[i.length - 1].value, r, ro(r, y, t)) ? i[i.length - 1].value = r : i.push({value: r}) : x && w !== r || i.push({value: w}), i
            }({
                maxTicks: i,
                bounds: t.bounds,
                min: t.min,
    ...
    const co = t => Math.floor(z(t)), uo = (t, e) => Math.pow(10, co(t) + e);
    ...
    class mo extends qs {
        ...
        buildTicks() {
            const t = this.options, e = po({min: this._userMin, max: this._userMax}, this);
    ...
    class So extends lo {
        ...
        setDimensions() {
            const t = this._padding = Mi(bo(this.options) / 2), e = this.width = this.maxWidth - t.width,
    ...
    function Ao(t, e, i, s) {
        ...
        for (let o = Do.indexOf(t); o < n - 1; ++o) {
            const t = Po[Do[o]], n = t.steps ? t.steps : Number.MAX_SAFE_INTEGER;
    ...
    class Eo extends qs {
        ...
        init(t, e = {}) {
            const i = t.time || (t.time = {}), s = this._adapter = new Pn._date(t.adapters.date);
        ...
        buildTicks() {
            ...
            return this._unit = e.unit || (i.autoSkip ? Ao(e.minUnit, this.min, this.max, this._getLabelCapacity(n)) : function (t, e, i, s, n) {
                ...
                for (let e = Do.indexOf(t) + 1, i = Do.length; e < i; ++e) if (Po[Do[e]].common) return Do[e]
        ...
        _generate() {
            const t = this._adapter, e = this.min, i = this.max, s = this.options, n = s.time,
                o = n.unit || Ao(n.minUnit, e, i, this._getLabelCapacity(e)), a = l(s.ticks.stepSize, 1),
        ...
        _getLabelCapacity(t) {
            const e = this.options.time, i = e.displayFormats, s = i[e.unit] || i.millisecond,
                n = this._tickFormatFunction(t, 0, Lo(this, [t], this._majorUnit), s), o = this._getLabelSize(n),
    ...
    var Ho = {
        id: "colors", defaults: {enabled: !0, forceOverride: !1}, beforeLayout(t, e, i) {
            if (!i.enabled) return;
            const {options: {elements: s}, data: {datasets: n}} = t.config;
    ...
    function Qo(t, e, i) {
        ...
        for (let n = 0; n < i.length; n++) {
            const o = i[n], {first: a, last: r, point: l} = ta(o, e, "x");
        ...
        const n = function (t) {
            if ((t.scale || {}).getPointPositionForValue) return function (t) {
                ...
                if (s.grid.circular) {
                    ...
                    return new ea({x: t.x, y: t.y, radius: e.getDistanceFromCenterForValue(r)})
                }
    ...
    function sa(t, e, i) {
        const s = ia(e), {line: n, scale: o, axis: a} = e, r = n.options, l = r.fill,
        ...
        s && n.points.length && (Re(t, i), function (t, e) {
            ...
            oa(t, {line: i, target: s, color: o, scale: r, property: l}), t.restore()
    ...
    function na(t, e, i) {
        ...
        t.beginPath();
        for (const r of s) {
            const {start: s, end: l} = r, h = n[s], c = n[Xo(s, l, n)];
    ...
    function oa(t, e) {
        const {line: i, target: s, property: n, color: o, scale: a} = e, r = function (t, e, i) {
            ...
            for (const t of s) {
                ...
                const h = Ei(e, l);
                for (const e of h) {
                    const s = Uo(i, o[e.start], o[e.end], e.loop), r = Li(t, n, s);
    ...
    class ca extends Bs {
        ...
        _draw() {
            ...
            const {boxWidth: g, boxHeight: p, itemHeight: m} = ha(o, d), b = this.isHorizontal(),
    ...
    class Aa extends Bs {
        ...
        getTitle(t, e) {
            const {callbacks: i} = e, s = Oa(i, "beforeTitle", this, t), n = Oa(i, "title", this, t),
        ...
        getBody(t, e) {
            ...
            return u(t, (t => {
                const e = {before: [], lines: [], after: []}, n = Da(i, t);
        ...
        getFooter(t, e) {
            const {callbacks: i} = e, s = Oa(i, "beforeFooter", this, t), n = Oa(i, "footer", this, t),
        ...
        update(t, e) {
            ...
            if (s.length) {
                ...
                const e = this._size = va(this, i), a = Object.assign({}, t, e), r = wa(this.chart, i, a),
        ...
        _drawColorBox(t, e, i, s, n) {
            const a = this.labelColors[i], r = this.labelPointStyles[i], {boxHeight: l, boxWidth: h, boxPadding: c} = n,
                d = wi(n.bodyFont), u = Sa(this, "left", n), f = s.x(u),
        ...
        _updateAnimationTarget(t) {
            ...
            if (s || n) {
                ...
                if (!i) return;
                const o = this._size = va(this, t), a = Object.assign({}, i, this._size), r = wa(e, t, a),
                    l = ka(t, a, r, e);
        ...
        _positionChanged(t, e) {
            const {caretX: i, caretY: s, options: n} = this, o = ba[n.position].call(this, t, e);
